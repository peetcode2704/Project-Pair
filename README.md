...
Given a file of 2D integer coordinates, this program determines how many unique right triangles can be formed using any three points. A triangle is considered "right" when the dot product of two edge vectors equals zero.
